...
public interface LivroControllerDocs {
        ...
        @Operation(summary = "Adicionando um novo Livro", description = "Adicionando um novo Livro no Sistema", tags = {
                        "Book" }, responses = {
        ...
        @Operation(summary = "Listando todos os Livros", description = "Listando todos os Livros", tags = {
                        "Book" }, responses = {
                                        @ApiResponse(description = "Success", responseCode = "200", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Livro.class)))),
        ...
        @Operation(summary = "Procurando Pelo Livro", description = "Procurando Por um Livro Específico", tags = {
                        "Book" }, responses = {
        ...
        @Operation(summary = "Atualizando o Livro", description = "Atualizando o Livro por ID", tags = {
                        "Book" }, responses = {
        ...
        @Operation(summary = "Deletando o Livro", description = "Deletando um Livro por ID", tags = {
                        "Book" }, responses = {
                                        @ApiResponse(description = "Success", responseCode = "200", content = @Content),
                                        @ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
                                        @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
